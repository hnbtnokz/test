...
<%--        if (CheckNum != "") {--%>
                            ...
                            <input type="hidden" name="CheckNum" id="CheckNum" value="X19060100001" /><%--20200406 ADD for test 新規でない--%>
                            <%--<input type="hidden" name="CheckNum" id="CheckNum" value="X19060100004" />--%><%--20200407 ADD for test 新規--%>
                            </td>
<%--        } else {
