...
<body>
    ...
    <form name="ESGroupWindow" method="post" action="#">
        ...
        <div id="estimate_system_group_window">
            ...
            <p class="new_group">
                <!--<input type="button" value="一覧へ戻る" onclick="open('about:blank', '_self').close();" />-->

                <%--20200323 EDIT--%>
                <input type="button" value="一覧へ戻る" id="BtnBackToList" onclick="estimateSystemGroupWindowBack();" />
<%--
                <input type="button" value="一覧へ戻る" id="BtnBack" />
...
--%>
            ...
            <table class="group_table" id="group_table">
                ...
                <tr>
                    <th rowspan="5" id="group_table_th">所属見積<br />
                        <input type="button" class="btn1" value="見積追加" onclick="estimateSystemGroupWindowDetailNew();" /></th>
                    <th style="width: 110px">見積番号/営業</th>
                    <th>見積件名/得意先CD・名</th>
                    <th style="width: 120px"></th>
                </tr>
                <%--●パラメータ見積番号がある場合 & tEstimateParentにCheckNumがある場合--%>
                <tr class="tr_new">
                    <td>見積件名01</td>
                    <td>得意先CD01：得意先名01</td>
                    <td>
                        <input type="button" class="btn3" id="new_add_btn" value="追 加" onclick="estimateSystemGroupWindowDetailAdd('X19060100003');" />
                    </td>
                </tr>
                <%--●パラメータ見積番号がある場合 & tEstimateParentにCheckNumがない場合--%>
                <tr class="tr_new">
                  <td>見積件名02</td>
                  <td>不明データ</td>
                  <td></td>
                ...
                <%-- 
                <tr id="LN_X19060100002" class="tr_delete">
                    <td>X19060100002<br />
                        <span class="leader_flag no_disp" id="LF_2">L </span>営業名2</td>
                    <td>見積件名2<br />
                        得意先CD2：得意先名2</td>
                    <td id="DL_2">削除</td>
                --%>
            ...
            <table class="group_search_table">
                <tr>
                    ...
                    <td rowspan="2">
                        <%--20200323 EDIT--%>
<%--                    <input type="button" class="btn1" value="検 索" onclick="estimateSystemGroupWindowSubmit('group_search');" /></td>--%>
